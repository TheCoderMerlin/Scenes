...
/// For example, both of the following statements will work:
///
/// ~~~
...
public class Tween<TweenElement: Tweenable> : InternalTweenProtocol, TweenProtocol {
    ...
    ///   - ease: The 'EasingStyle' to apply
    ///   - update: The value to update
    public init(from:TweenElement, to:TweenElement, speed:Double, ease:EasingStyle = .linear, update:@escaping UpdateHandler<TweenElement>) {
